...
To verify that this module works do the following:
    ...
    6. Run python ./Unbiased_LTR/DLA/main.py --max_train_iteration 10000 --data_dir ./Input_Data/ --click_model_json ./Example_files/ClickModel/sm_1_0_1_1.json --train_dir ./DLA_data/train_dir/ --test_dir ./DLA_data/test_dir --hparams "learning_rate=0.05", "hidden_layer_sizes=100", "loss_func='clicked_weighted_softmax_cross_entropy", "logits_to_prob = 'softmax'", "grad_strategy='ada'" --self_test False
    7. python ./Unbiased_LTR/IPW_LTR/main.py --max_train_iteration 10000 --data_dir ./Input_Data/ --click_model_json ./Example_files/ClickModel/sm_1_0_1_1.json --train_dir ./IPW_data/train_dir/ --test_dir ./IPW_data/test_dir --estimator_json ./Example_files/PropensityEstimator/randomized_sm_1_0_1_1.json  --hparams "learning_rate=0.05", "hidden_layer_sizes=100", "loss_func='clicked_weighted_softmax_cross_entropy" --self_test False
